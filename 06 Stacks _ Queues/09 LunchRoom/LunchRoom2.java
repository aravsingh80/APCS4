...
public class LunchRoom2
{
   ...
   public static void main(String[] args)
   {
      ...
      try
      {
         outfile = new PrintWriter(new FileWriter("LunchRoom.txt"));
      }
      catch(IOException e)
      {
      ...
      for(int x = 0; x < TIME; x++)
      {
         ...
         {
            String s = grade();
            Customer c = new Customer(s, x, time(), false);
            queue.add(c);
      ...
      /* report the data  */
      outfile.println("Senior\t\t" + seTotal + "\t\t\t"+ seLongest + "\t\t\t\t" + (double)seTotalTime / (double)seTotal);
      outfile.println("Junior\t\t" + juTotal + "\t\t\t"+ juLongest +" \t\t\t" + (double)juTotalTime / (double)juTotal);
      outfile.println("Sophomore\t" + soTotal + "\t\t\t"+ soLongest +" \t\t\t" + (double)soTotalTime / (double)soTotal);  
      outfile.println("Freshman\t\t" + frTotal + "\t\t\t"+ frLongest +" \t\t\t" + (double)frTotalTime / (double)frTotal);
      outfile.close();
   }
